...
const AddEditNotes = ({noteData, type, getAllNotes, onClose}) => {
    ...
    const handleAddNote = () =>{
        ...
        if(!title){
            setError("Please enter the title of the task");
            return;
        }
        if(!content){
            setError("Please enter the content of the task");
            return;
        }
        ...
        <div className="relative">
            ...
            <div className="flex flex-col gap-2">
                ...
                <input type="text" className="text-2xl text-slate-950 outline-none" 
                        placeholder="Write your title here" value={title}
            ...
            <div className="flex flex-col gap-2 mt-4">
                ...
                <textarea type="text"
                    ...
                    placeholder="Content" rows={10} value={content}
